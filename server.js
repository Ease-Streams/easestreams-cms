...
const currentPort = parseInt(process.env.PORT, 10) || 9000
...
const nextConfig = {
  ...
  outputFileTracingRoot: 'D:\\EaseStreams.com\\easestreams-cms',
  experimental: {
    cacheLife: {
    ...
    turbo: {
      resolveAlias: { 'payload-mock-package': 'payload-mock-package' },
      root: 'D:\\EaseStreams.com\\easestreams-cms',
    },
    typedRoutes: false,
    typedEnv: false,
